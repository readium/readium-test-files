...
curl --user "$USER:$PASS" --include --request POST --data '{"name":"type:FAQ","color":"674ea7"}' "https://api.github.com/repos/$REPO/labels"
curl --user "$USER:$PASS" --include --request POST --data '{"name":"type:TestCase","color":"674ea7"}' "https://api.github.com/repos/$REPO/labels"
...
curl --user "$USER:$PASS" --include --request POST --data '{"name":"func:Markup","color":"b6d7a8"}' "https://api.github.com/repos/$REPO/labels"
...
curl --user "$USER:$PASS" --include --request POST --data '{"name":"func:Events","color":"b6d7a8"}' "https://api.github.com/repos/$REPO/labels"
...
curl --user "$USER:$PASS" --include --request POST --data '{"name":"func:Parser","color":"b6d7a8"}' "https://api.github.com/repos/$REPO/labels"
...
curl --user "$USER:$PASS" --include --request POST --data '{"name":"func:API","color":"b6d7a8"}' "https://api.github.com/repos/$REPO/labels"
